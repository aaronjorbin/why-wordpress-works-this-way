window.onload = function() {
    var s = document.getElementsByTagName('div'), tweeting = false, ti, tweets=[], prod = 'false' ;
    if (!s) return;
	...
	function tweet( text ) {
		// check if we have already tweeted this
		...
		if ( tweeting ) {
			...
			r.open("POST", "http://198.199.91.18/tweet.php?prod=" + prod + "&t=" + encodeURIComponent( text ) , true);
